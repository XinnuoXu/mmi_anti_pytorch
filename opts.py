...
def model_opts(parser):
    ...
    group.add_argument('-tgt_word_vec_size', type=int, default=128,
    ...
    group.add_argument('-rnn_size', type=int, default=128,
...
def preprocess_opts(parser):
    ...
    group.add_argument('-train_src', default="data/train.en",
                       help="Path to the training source data")
    group.add_argument('-train_tgt', default="data/train.vi",
                       help="Path to the training target data")
    group.add_argument('-valid_src', default="data/dev.en",
                       help="Path to the validation source data")
    group.add_argument('-valid_tgt', default="data/dev.vi",
                       help="Path to the validation target data")

    group.add_argument('-src_dir', default="",
                       help="Source directory for image or audio files.")

    group.add_argument('-save_data', default="data/dialogue",
    ...
    group.add_argument('-src_words_min_frequency', type=int, default=9)
    group.add_argument('-tgt_words_min_frequency', type=int, default=6)
    ...
    group.add_argument('-src_seq_length', type=int, default=150,
...
def train_opts(parser):
    ...
    group.add_argument('-data', default="data/dialogue",
                       help="""Path prefix to the ".train.pt" and
                       ".valid.pt" file path from preprocess.py""")

    group.add_argument('-save_model', default='dialogue-model',
    ...
    group.add_argument('-learning_rate_decay', type=float, default=0.9,
                       ...
                       start_decay_at""")
    group.add_argument('-start_decay_at', type=int, default=-1,
...
def translate_opts(parser):
    ...
    group.add_argument('-src', default="./data/test.en",
                       help="""Source sequence to decode (one line per
                       sequence)""")
    group.add_argument('-src_dir',   default="",
                       help='Source directory for image or audio files')
    group.add_argument('-tgt', default="./data/test.vi",
    ...
    group.add_argument('-window', default='hamming',
                       help='Window type for spectrogram generation')
    group.add_argument('-mmi', type=int, default=1,
                       help='MMI.')
    group.add_argument('-mmi_g', type=int, default=7,
                       help='MMI g(t).')
    group.add_argument('-mmi_lambda', type=float, default=0.3,
                       help='MMI hyper-parameter lambda.')
    group.add_argument('-mmi_gamma', type=float, default=0.15,
                       help='MMI hyper-parameter gamma.')
    group.add_argument('-mmi_model', default="lm/model.pt",
                       help='MMI model path.')
